...
@RestController
@RequestMapping("/api/blm-kafka")
public class BlmKafkaResource {
    private final Logger log = LoggerFactory.getLogger(BlmKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BlmKafkaResource(KafkaProperties kafkaProperties) {
